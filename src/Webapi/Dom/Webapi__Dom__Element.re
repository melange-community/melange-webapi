...
module Impl = (T: {type t;}) => {
  ...
  [@mel.get] [@mel.return nullable] external namespaceURI : T.t => option(string) = "namespaceURI";
  ...
  [@mel.get] [@mel.return nullable] external prefix : T.t => option(string) = "prefix";
  ...
  [@mel.send.pipe : T.t] external attachShadow : {. "mode": string} => Dom.shadowRoot = "attachShadow"; /* experimental */
  [@mel.send.pipe : T.t] external attachShadowOpen : ([@mel.as {json|{ "mode": "open" }|json}] _) => Dom.shadowRoot = "attachShadow"; /* experimental */
  [@mel.send.pipe : T.t] external attachShadowClosed : ([@mel.as {json|{ "mode": "closed" }|json}] _) => Dom.shadowRoot = "attachShadow"; /* experimental */
  [@mel.send.pipe : T.t] external animate : (Js.t({..}), Js.t({..})) => Dom.animation = "animate"; /* experimental */
  [@mel.send.pipe : T.t] [@mel.return nullable] external closest : string => option(Dom.element) = "closest"; /* experimental */
  [@mel.send.pipe : T.t] external createShadowRoot : Dom.shadowRoot = "createShadowRoot"; /* experimental AND deprecated (?!) */
  [@mel.send.pipe : T.t] [@mel.return nullable] external getAttribute : string => option(string) = "getAttribute";
  [@mel.send.pipe : T.t] [@mel.return nullable] external getAttributeNS : (string, string) => option(string) = "getAttributeNS";
  [@mel.send.pipe : T.t] external getBoundingClientRect : Dom.domRect = "getBoundingClientRect";
  [@mel.send.pipe : T.t] external getClientRects : array(Dom.domRect) = "getClientRects";
  ...
  [@mel.send.pipe : T.t] external hasAttributeNS : (string, string) => bool = "hasAttributeNS";
  [@mel.send.pipe : T.t] external hasAttributes : bool = "hasAttributes";
  [@mel.send.pipe : T.t] external insertAdjacentElement : (string /* insertPosition enum */, Dom.element_like('a)) => unit = "insertAdjacentElement"; /* experimental, but widely supported */
  ...
  [@mel.send.pipe : T.t] external insertAdjacentHTML : (string /* insertPosition enum */, string) => unit = "insertAdjacentHTML"; /* experimental, but widely supported */
  ...
  [@mel.send.pipe : T.t] external insertAdjacentText : (string /* insertPosition enum */, string) => unit = "insertAdjacentText"; /* experimental, but widely supported */
  ...
  [@mel.send.pipe : T.t] external releasePointerCapture : Dom.eventPointerId => unit = "releasePointerCapture";
  [@mel.send.pipe : T.t] external removeAttribute : string => unit = "removeAttribute";
  [@mel.send.pipe : T.t] external removeAttributeNS : (string, string) => unit = "removeAttributeNS";
  [@mel.send.pipe : T.t] external requestFullscreen : unit = "requestFullscreen"; /* experimental */
  [@mel.send.pipe : T.t] external requestPointerLock : unit = "requestPointerLock"; /* experimental */
  [@mel.send.pipe : T.t] external scrollIntoView : unit = "scrollIntoView"; /* experimental, but widely supported */
  [@mel.send.pipe : T.t] external scrollIntoViewNoAlignToTop : ([@mel.as {json|true|json}] _) => unit = "scrollIntoView"; /* experimental, but widely supported */
  [@mel.send.pipe : T.t] external scrollIntoViewWithOptions : {. "behavior": string, "block": string} => unit = "scrollIntoView"; /* experimental */
  [@mel.send.pipe : T.t] external scrollBy : (float, float) => unit = "scrollBy";
  [@mel.send.pipe : T.t] external scrollByWithOptions : {. "top": float, "left": float, "behavior": string} => unit = "scrollBy";
  [@mel.send.pipe : T.t] external scrollTo : (float, float) => unit = "scrollTo";
  [@mel.send.pipe : T.t] external scrollToWithOptions : {. "top": float, "left": float, "behavior": string} => unit = "scrollTo";
  [@mel.send.pipe : T.t] external setAttribute : (string, string) => unit = "setAttribute";
  [@mel.send.pipe : T.t] external setAttributeNS : (string, string, string) => unit = "setAttributeNS";
  [@mel.send.pipe : T.t] external setPointerCapture : Dom.eventPointerId => unit = "setPointerCapture";

  /* GlobalEventHandlers interface */
  /* Not sure this should be exposed, since EventTarget seems like a better API */

  [@mel.set] external setOnClick : (T.t, Dom.mouseEvent => unit) => unit = "onclick";
};
