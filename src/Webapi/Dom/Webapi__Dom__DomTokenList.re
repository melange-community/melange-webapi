...
[@mel.send.pipe : t] [@mel.return nullable] external item : int => option(string) = "item";
[@mel.send.pipe : t] external add : string => unit = "add";
[@mel.send.pipe : t] [@mel.splice] external addMany : array(string) => unit = "add";
[@mel.send.pipe : t] external contains : string => bool = "contains";
/* entries: iterator API, should have language support */
[@mel.send.pipe : t] external forEach : ((string, int) => unit) => unit = "forEach";
/* keys: iterator API, should have language support */
[@mel.send.pipe : t] external remove : string => unit = "remove";
[@mel.send.pipe : t] [@mel.splice] external removeMany : array(string) => unit = "remove";
...
[@mel.send.pipe : t] external toggleForced : (string, [@mel.as {json|true|json}] _) => bool = "toggle";
