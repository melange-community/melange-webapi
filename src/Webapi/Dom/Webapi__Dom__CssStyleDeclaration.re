...
[@mel.send.pipe : t] external getPropertyPriority : string => string = "getPropertyPriority";
[@mel.send.pipe : t] external getPropertyValue : string => string = "getPropertyValue";
[@mel.send.pipe : t] external item : int => string = "item";
[@mel.send.pipe : t] external removeProperty : string => string = "removeProperty";
[@mel.send.pipe : t] external setProperty : (string, string, string) => unit = "setProperty";
/*[@@bs.send.pipe : t] external setPropertyValue : (string, string) => unit = "setPropertyValue";*/ /* not mentioned by MDN and not implemented by chrome, but in the CSSOM spec:  https://drafts.csswg.org/cssom/#the-cssstyledeclaration-interface */
