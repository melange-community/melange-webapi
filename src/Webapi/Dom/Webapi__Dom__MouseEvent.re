module Impl = (T: {type t;}) => {
  ...
  [@mel.get] [@mel.return nullable] external region : T.t => option(string) = "region";
  [@mel.get] [@mel.return nullable] external relatedTarget : T.t => option(Dom.eventTarget) = "relatedTarget";
  ...
  [@mel.send.pipe : T.t] external getModifierState : string /* modifierKey enum */ => bool = "getModifierState";
