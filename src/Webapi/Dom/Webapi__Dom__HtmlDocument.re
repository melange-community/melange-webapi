module Impl = (T: {type t;}) => {
  ...
  [@mel.get] [@mel.return nullable] external activeElement : t_htmlDocument => option(Dom.element) = "activeElement";
  [@mel.get] [@mel.return nullable] external body : t_htmlDocument => option(Dom.element) = "body"; /* returns option HTMLBodyElement */
  ...
  [@mel.get] [@mel.return nullable] external defaultView : t_htmlDocument => option(Dom.window) = "defaultView";
  [@mel.get] external designMode : t_htmlDocument => string /* designMode enum */ = "designMode";
  let designMode: t_htmlDocument => Webapi__Dom__Types.designMode =
    (self) => Webapi__Dom__Types.decodeDesignMode(designMode(self));
  [@mel.set] external setDesignMode : (t_htmlDocument, string /* designMode enum */) => unit = "designMode";
  ...
  [@mel.set] external setDir : (t_htmlDocument, string /* dir enum */) => unit = "dir";
  let setDir: (t_htmlDocument, Webapi__Dom__Types.dir) => unit =
    (self, value) => setDir(self, Webapi__Dom__Types.encodeDir(value));
  [@mel.get] [@mel.return nullable] external domain : t_htmlDocument => option(string) = "domain";
  ...
  [@mel.set] external setLocation : (t_htmlDocument, string) => unit = "location";
  [@mel.get] external plugins : t_htmlDocument => Dom.htmlCollection = "plugins";
  [@mel.get] external readyState : t_htmlDocument => string /* enum */ = "readyState";
  ...
  [@mel.send.pipe : t_htmlDocument] external execCommand : (string, bool, Js.null(string)) => bool = "execCommand";
  ...
  [@mel.send.pipe : t_htmlDocument] external getElementsByName : string => Dom.nodeList = "getElementsByName";
  [@mel.send.pipe : t_htmlDocument] external getSelection : Dom.selection = "getSelection";
  [@mel.send.pipe : t_htmlDocument] external hasFocus : bool = "hasFocus";
  [@mel.send.pipe : t_htmlDocument] external open_ : unit = "open";
  [@mel.send.pipe : t_htmlDocument] external queryCommandEnabled : string => bool = "queryCommandEnabled";
  [@mel.send.pipe : t_htmlDocument] external queryCommandIndeterm : string => bool = "queryCommandIndeterm";
  [@mel.send.pipe : t_htmlDocument] external queryCommandSupported : string => bool = "queryCommandSupported";
  [@mel.send.pipe : t_htmlDocument] external queryCommandValue : string => string = "queryCommandValue";
