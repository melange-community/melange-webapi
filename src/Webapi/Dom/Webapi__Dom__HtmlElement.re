module Impl = (T: {type t;}) => {
  ...
  [@mel.get] external accessKeyLabel : t_htmlElement => string = "accessKeyLabel";
  [@mel.get] external contentEditable : t_htmlElement => string /* enum */ = "contentEditable";
  ...
  [@mel.set] external setContentEditable : (t_htmlElement, string /* enum */) => unit = "contentEditable";
  ...
  [@mel.get] external isContentEditable : t_htmlElement => bool = "isContentEditable";
  [@mel.get] external contextMenu : t_htmlElement => Dom.htmlElement = "contextMenu"; /* returns HTMLMenuElement */
  [@mel.set] external setContextMenu : (t_htmlElement, Dom.htmlElement) => unit = "contextMenu"; /* accepts and returns HTMLMenuElement */
  ...
  [@mel.set] external setDir : (t_htmlElement, string /* enum */) => unit = "dir";
  ...
  [@mel.set] external setDraggable : (t_htmlElement, bool) => unit = "draggable";
  ...
  [@mel.get] external dropzone : t_htmlElement => Dom.domSettableTokenList = "dropzone";
  [@mel.get] external hidden : t_htmlElement => bool = "hidden";
  [@mel.set] external setHidden : (t_htmlElement, bool) => unit = "hidden";
  ...
  [@mel.set] external setItemScope : (t_htmlElement, bool) => unit = "itemScope";
  ...
  [@mel.get] external itemType : t_htmlElement => Dom.domSettableTokenList = "itemType"; /* experimental */
  ...
  [@mel.get] external itemRef : t_htmlElement => Dom.domSettableTokenList = "itemRef"; /* experimental */
  [@mel.get] external itemProp : t_htmlElement => Dom.domSettableTokenList = "itemProp"; /* experimental */
  [@mel.get] external itemValue : t_htmlElement => Js.t({..}) = "itemValue"; /* experimental */
  [@mel.set] external setItemValue : (t_htmlElement, Js.t({..})) => unit = "itemValue"; /* experimental */
  ...
  [@mel.get] [@mel.return nullable] external offsetParent : t_htmlElement => option(Dom.element) = "offsetParent"; /* experimental */
  ...
  [@mel.set] external setSpellcheck : (t_htmlElement, bool) => unit = "spellcheck" ;
  ...
  [@mel.set] external setStyle : (t_htmlElement, Dom.cssStyleDeclaration) => unit = "style";
  ...
  [@mel.set] external setTranslate : (t_htmlElement, bool) => unit = "translate"; /* experimental */
  ...
  [@mel.send.pipe : t_htmlElement] external focusPreventScroll : ([@mel.as {json|{ "preventScroll": true }|json}] _) => unit = "focus";
  [@mel.send.pipe : t_htmlElement] external forceSpellCheck : unit = "forceSpellCheck"; /* experimental */
