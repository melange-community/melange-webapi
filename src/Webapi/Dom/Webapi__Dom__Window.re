...
module Impl = (T: {type t;}) => {
  ...
  [@mel.get] [@mel.return nullable] external frameElement : t_window => option(Dom.element) = "frameElement"; /* experimental? */
  ...
  [@mel.get] [@mel.return nullable] external opener : t_window => option(Dom.window) = "opener";
  ...
  [@mel.get] external performance : t_window => Webapi__Performance.t = "performance";
  ...
  [@mel.get] external speechSynthesis : t_window => speechSynthesis = "speechSynthesis"; /* experimental */
  ...
  [@mel.send.pipe : t_window] external cancelIdleCallback : idleCallbackId => unit = "cancelIdleCallback"; /* experimental, Cooperative Scheduling of Background Tasks */
  ...
  [@mel.send.pipe : t_window] external getComputedStyle : Dom.element => Dom.cssStyleDeclaration = "getComputedStyle";
  [@mel.send.pipe : t_window] external getComputedStyleWithPseudoElement : (Dom.element, string) => Dom.cssStyleDeclaration = "getComputedStyle";
  [@mel.send.pipe : t_window] external getSelection : Dom.selection = "getSelection";
  [@mel.send.pipe : t_window] external matchMedia : string => mediaQueryList = "matchMedia"; /* experimental, CSSOM View module */
  ...
  [@mel.send.pipe : t_window] [@mel.return nullable] external open_ : (~url: string, ~name: string, ~features: string=?) => option(Dom.window) = "open"; /* yes, features is a stringly typed list of key value pairs, sigh */
  [@mel.send.pipe : t_window] external postMessage : ('a, string) => unit = "postMessage"; /* experimental-ish?, Web Messaging */
  [@mel.send.pipe : t_window] external postMessageWithTransfers : ('a, string, array(transferable)) => unit = "postMessage"; /* experimental-ish?, Web Messaging */
  [@mel.send.pipe : t_window] external print : unit = "print";
  [@mel.send.pipe : t_window] external prompt : string => string = "prompt";
  [@mel.send.pipe : t_window] external promptWithDefault : (string, string) => string = "prompt";
  /* requestAnimationFrame: accessed directly via Webapi */
  [@mel.send.pipe : t_window] external requestIdleCallback : (idleDeadline => unit) => idleCallbackId = "requestIdleCallback"; /* experimental, Cooperative Scheduling of Background Tasks */
  [@mel.send.pipe : t_window] external requestIdleCallbackWithOptions : (idleDeadline => unit, {. "timeout": int}) => idleCallbackId = "requestIdleCallback"; /* experimental, Cooperative Scheduling of Background Tasks */
  ...
  [@mel.send.pipe : t_window] external scrollBy : (float, float) => unit = "scrollBy"; /* experimental, CSSOM View module */
  [@mel.send.pipe : t_window] external scrollTo : (float, float) => unit = "scrollTo"; /* experimental, CSSOM View module */
  [@mel.send.pipe : t_window] external stop : unit = "stop";

  [@mel.send.pipe : t_window] external addPopStateEventListener : ([@mel.as "popstate"] _, Dom.popStateEvent => unit) => unit = "addEventListener";
  [@mel.send.pipe : t_window] external removePopStateEventListener : ([@mel.as "popstate"] _, Dom.popStateEvent => unit) => unit= "removeEventListener";
