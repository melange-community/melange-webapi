...
[@mel.set] external setScrollRestoration : (t, bool) => unit = "scrollRestoration"; /* experimental */
...
[@mel.send.pipe : t] external pushState : (state, string, string) => unit = "pushState";
[@mel.send.pipe : t] external replaceState : (state, string, string) => unit = "replaceState";
