...
[@mel.get] external state: t => state('a) = "state";
...
[@mel.send]
external pushState: (state('a), string, string, [@mel.this] t) => unit =
  "pushState";
[@mel.send]
external replaceState: (state('a), string, string, [@mel.this] t) => unit =
  "replaceState";
