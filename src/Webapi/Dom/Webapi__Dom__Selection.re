...
[@mel.get] [@mel.return nullable] external anchorNode : t => option(Dom.node) = "anchorNode";
[@mel.get] external anchorOffset : t => int = "anchorOffset";
[@mel.get] [@mel.return nullable] external focusNode : t => option(Dom.node) = "focusNode";
...
[@mel.send.pipe : t] external collapse : (Dom.node_like(_), int) => unit = "collapse";
[@mel.send.pipe : t] external extend : (Dom.node_like(_), int) => unit = "extend";
[@mel.send.pipe : t] external collapseToStart : unit = "collapseToStart";
[@mel.send.pipe : t] external collapseToEnd : unit = "collapseToEnd";
[@mel.send.pipe : t] external selectAllChildren : Dom.node_like(_) => unit = "selectAllChildren";
[@mel.send.pipe : t] external setBaseAndExtent : (Dom.node_like(_), int,  Dom.node_like(_), int) => unit = "setBaseAndExtent";
...
[@mel.send.pipe : t] external containsNode : (Dom.node_like(_), [@mel.as {json|false|json}] _) => bool = "containsNode";
[@mel.send.pipe : t] external containsNodePartly : (Dom.node_like(_), [@mel.as {json|true|json}] _) => bool = "containsNode";
