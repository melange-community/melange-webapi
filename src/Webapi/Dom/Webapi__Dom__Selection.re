...
[@bs.send.pipe : t] external setBaseAndExtent : (Dom.node_like(_), int,  Dom.node_like(_), int) => unit = "setBaseAndExtent";
...
[@bs.send.pipe : t] external containsNode : (Dom.node_like(_), [@bs.as {json|false|json}] _) => bool = "containsNode";
