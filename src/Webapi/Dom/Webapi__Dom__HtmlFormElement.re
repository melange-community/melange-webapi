...
module Impl = (T: {type t;}) => {
  ...
  [@mel.get] external acceptCharset : t_htmlFormElement => string = "acceptCharset";
  [@mel.set] external setAcceptCharset : (t_htmlFormElement, string) => unit = "acceptCharset";
  [@mel.get] external autocomplete : t_htmlFormElement => string = "autocomplete";
  [@mel.set] external setAutocomplete : (t_htmlFormElement, string) => unit = "autocomplete";
  [@mel.get] external noValidate : t_htmlFormElement => bool = "noValidate";
  [@mel.set] external setNoValidate : (t_htmlFormElement, bool) => unit = "noValidate";
  [@mel.get] external enctype : t_htmlFormElement => string = "enctype";
  [@mel.set] external setEnctype : (t_htmlFormElement, string) => unit = "enctype";
  [@mel.get] external encoding : t_htmlFormElement => string = "encoding";
  [@mel.set] external setEncoding : (t_htmlFormElement, string) => unit = "encoding";

  [@mel.send.pipe: t_htmlFormElement] external submit : unit = "submit";
  [@mel.send.pipe: t_htmlFormElement] external reset : unit = "reset";
  [@mel.send.pipe: t_htmlFormElement] external checkValidity : bool = "checkValidity";
  [@mel.send.pipe: t_htmlFormElement] external reportValidity : bool = "reportValidity";

  /** @since 0.18.0 */
  [@mel.new] external data: T.t => Fetch.FormData.t = "FormData";
};
