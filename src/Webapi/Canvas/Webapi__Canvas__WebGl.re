...
[@mel.send] external clearColor : (glT, float, float, float, float) => unit = "clearColor";
...
[@mel.send] external bufferData : (glT, int, Js.Typed_array.Uint16Array.t, int) => unit = "bufferData";
[@mel.send] external bufferFloatData : (glT, int, Js.Typed_array.Float32Array.t, int) => unit = "bufferData";
...
[@mel.send] external getProgramInfoLog : (glT, programT) => string = "getProgramInfoLog";
[@mel.send] external bindAttribLocation : (glT, programT, int, string) => unit = "bindAttribLocation";
[@mel.send] external createShader : (glT, int) => shaderT = "createShader";
[@mel.send] external shaderSource : (glT, shaderT, string) => unit = "shaderSource";
[@mel.send] external compileShader : (glT, shaderT) => unit = "compileShader";
[@mel.send] external attachShader : (glT, programT, shaderT) => unit = "attachShader";
[@mel.send] external getShaderInfoLog : (glT, shaderT) => string = "getShaderInfoLog";
/* void drawElements(GLenum mode, GLsizei count, GLenum type, GLintptr offset); */
[@mel.send] external drawElements : (glT, int, int, int, int) => unit = "drawElements";
/* void enableVertexAttribArray(GLuint index); */
[@mel.send] external enableVertexAttribArray : (glT, int) => unit = "enableVertexAttribArray";
/* void vertexAttribPointer(GLuint indx, GLint size, GLenum type,
   GLboolean normalized, GLsizei stride, GLintptr offset); */
[@mel.send] external vertexAttribPointer : (glT, int, int, int, bool, int, int) => unit = "vertexAttribPointer";
/* GLint gl.getAttribLocation(program, name); */
[@mel.send] external getAttribLocation : (glT, programT, string) => int = "getAttribLocation";
