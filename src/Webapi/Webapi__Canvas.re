...
module CanvasElement = {
  [@mel.send] external getContext2d : (Dom.element, [@mel.as "2d"] _) => Canvas2d.t = "getContext";
  [@mel.send] external getContextWebGl : (Dom.element, [@mel.as "webgl"] _) => WebGl.glT = "getContext";
