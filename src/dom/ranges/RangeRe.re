...
[@bs.get] external commonAncestorContainer : t => Dom.node = "commonAncestorContainer";
...
[@bs.send.pipe : t] external setStart : (Dom.node_like('a), int) => unit = "setStart";
[@bs.send.pipe : t] external setEnd : (Dom.node_like('a), int) => unit = "setEnd";
[@bs.send.pipe : t] external setStartBefore : Dom.node_like('a) => unit = "setStartBefore";
[@bs.send.pipe : t] external setStartAfter : Dom.node_like('a) => unit = "setStartAfter";
[@bs.send.pipe : t] external setEndBefore : Dom.node_like('a) => unit = "setEndBefore";
[@bs.send.pipe : t] external setEndAfter : Dom.node_like('a) => unit = "setEndAfter";
[@bs.send.pipe : t] external selectNode : Dom.node_like('a) => unit = "selectNode";
...
let compareBoundaryPoint: (DomTypesRe.compareHow, t, t) => DomTypesRe.compareResult =
  (how, range, self) =>
    DomTypesRe.decodeCompareResult(
      compareBoundaryPoints(DomTypesRe.encodeCompareHow(how), range, self)
    );
...
let comparePoint: (Dom.node_like('a), int, t) => DomTypesRe.compareResult =
  (node, offset, self) => DomTypesRe.decodeCompareResult(comparePoint(node, offset, self));
