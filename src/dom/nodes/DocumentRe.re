module Impl = (T: {type t;}) => {
  ...
  let visibilityState: T.t => DomTypesRe.visibilityState =
    (self) => DomTypesRe.decodeVisibilityState(visibilityState(self));
  ...
  [@bs.send.pipe : T.t] external createNodeIteratorWithWhatToShowFilter : (Dom.node_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) => Dom.nodeIterator = "createNodeIterator"; /* createProcessingInstruction */
  ...
  [@bs.send.pipe : T.t] external createTreeWalkerWithWhatToShow : (Dom.element_like('a), DomTypesRe.WhatToShow.t) => Dom.treeWalker = "createTreeWalker";
  [@bs.send.pipe : T.t] external createTreeWalkerWithWhatToShowFilter : (Dom.element_like('a), DomTypesRe.WhatToShow.t, Dom.nodeFilter) => Dom.treeWalker = "createTreeWalker";
