module Impl = (T: {type t;}) => {
  ...
  */
  ...
  [@bs.get] [@bs.return nullable] external parentElement : T.t => option(Dom.element) = "parentElement";
  [@bs.get] [@bs.return nullable] external parentNode : T.t => option(Dom.node) = "parentNode";
  [@bs.get] [@bs.return nullable] external previousSibling : T.t => option(Dom.node) = "previousSibling";
  ...
  [@bs.send.pipe : T.t] external appendChild : Dom.node_like('a) => unit = "appendChild";
  ...
  [@bs.send.pipe : T.t] external compareDocumentPosition : Dom.node_like('a) => int = "compareDocumentPosition"; /* returns a bitmask which could also be represeneted as an enum, see https://developer.mozilla.org/en-US/docs/Web/API/Node/compareDocumentPosition */
  [@bs.send.pipe : T.t] external contains : Dom.node_like('a) => bool = "contains";
  ...
  [@bs.send.pipe : T.t] external insertBefore : (Dom.node_like('a), Dom.node_like('b)) => Dom.node_like('a) = "insertBefore";
  ...
  */
  [@bs.send.pipe : T.t] external isDefaultNamespace : string => bool = "isDefaultNamespace";
  [@bs.send.pipe : T.t] external isEqualNode : Dom.node_like('a) => bool = "isEqualNode";
  [@bs.send.pipe : T.t] external isSameNode : Dom.node_like('a) => bool = "isSameNode";
