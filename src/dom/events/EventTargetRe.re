module Impl = (T: {type t;}) => {
  ...
  [@bs.send.pipe : T.t] external addEventListener : (string, Dom.event => unit) => unit = "addEventListener";
  ...
  [@bs.send.pipe : T.t] external removeEventListener : (string, Dom.event => unit) => unit = "removeEventListener";
  ...
  [@bs.send.pipe : T.t] external dispatchEvent : Dom.event_like('a) => bool = "dispatchEvent";
