module Impl = (T: {type t;}) => {
  ...
  let contentEditable: t_htmlElement => DomTypesRe.contentEditable =
    (self) => DomTypesRe.decodeContentEditable(contentEditable(self));
  [@bs.set] external setContentEditable : (t_htmlElement, string /* enum */) => unit = "contentEditable";
  let setContentEditable: (t_htmlElement, DomTypesRe.contentEditable) => unit =
    (self, value) => setContentEditable(self, DomTypesRe.encodeContentEditable(value));
  ...
  let dir: t_htmlElement => DomTypesRe.dir = (self) => DomTypesRe.decodeDir(dir(self));
  [@bs.set] external setDir : (t_htmlElement, string /* enum */) => unit = "dir";
  let setDir: (t_htmlElement, DomTypesRe.dir) => unit =
